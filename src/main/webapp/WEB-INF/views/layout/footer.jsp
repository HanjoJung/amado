                            ...
                            <nav class="navbar navbar-expand-lg justify-content-end">
                                ...
                                <div class="collapse navbar-collapse" id="footerNavContent">
                                    <ul class="navbar-nav ml-auto">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{pageContext.request.contextPath}/product/product">Product</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="{pageContext.request.contextPath}/product/cart">Cart</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="{pageContext.request.contextPath}/product/checkout">Checkout</a>
                                        </li>
                                    </ul>
                                </div>
                            </nav>
